(function () {
  ...
  /* ── 1. STIJLEN ─────────────────────────────────────────────────────────── */
  var css = `
    #snrg-kh-btn { display: block; width: 100%; text-align: center; background: #ffb914; color: #111; font-family: inherit; font-size: 14px; font-weight: 700; padding: 10px 16px; border-radius: 20px; border: none; cursor: pointer; transition: background .15s; letter-spacing: normal; }
    #snrg-kh-btn:hover { background: #e0a210; }
    #snrg-kh-overlay { display: none; position: fixed; inset: 0; background: rgba(0,0,0,.45); z-index: 9999; align-items: center; justify-content: center; padding: 1rem; }
    #snrg-kh-overlay.open { display: flex; }
    #snrg-kh-modal { background: #fff; border-radius: 10px; width: 100%; max-width: 580px; max-height: 90vh; overflow-y: auto; box-shadow: 0 8px 40px rgba(0,0,0,.2); }
    .kh-topbar { background: #111; border-radius: 10px 10px 0 0; padding: 10px 16px; display: flex; align-items: center; gap: 10px; position: sticky; top: 0; z-index: 1; }
    ...
    .kh-topbar-close { background: none; border: none; color: rgba(255,255,255,.5); font-size: 18px; cursor: pointer; padding: 0; line-height: 1; margin-left: 8px; }
    ...
    .kh-option { display: flex; align-items: center; gap: 0; padding: 10px 13px; border: 1px solid #e2dbd3; border-radius: 6px; background: #faf8f5; cursor: pointer; text-align: left; width: 100%; font-family: inherit; transition: border-color .12s, background .12s; letter-spacing: normal; }
    ...
    .kh-tag.warn { border-color: #e8b04b; color: #8a5a00; background: #fff5e0; }
  ...
  /* ── 3. PRODUCTEN ───────────────────────────────────────────────────────── */
  /* type: 'pnp' (stopcontact) | 'groep' (aparte groep) | 'vast' (installatie)
     module: true = losse batterij, aparte omvormer nodig
     g: doel-score (solar/saving/dynamic) 0..3 ; backup-doel via filter           */
  var PRODUCTS = {
    hoymiles: { featured: true, naam: "Hoymiles Plug-In Battery MS-A2 · 2,24 kWh", prijs: "€ 998,–",
      ...
      tags: ["2,24 kWh", "Stopcontact", "Geen installateur", "P1-monitoring"], stock: "Op voorraad",
      url: "https://solarnrg.shop/thuisbatterijen/hoymiles-plug-in-battery-ms-a2-2-24kwh-p1-monitoring/",
      type: "pnp", module: false, backup: false, kwhMin: 2.24, kwhMax: 2.24, g: { solar: 1, saving: 3, dynamic: 2 } },
    aeg_solarcube: { featured: true, naam: "AEG Solarcube · 4,8 kWh", prijs: "€ 1.750,–",
      ...
      tags: ["4,8 kWh", "Uitbreidbaar tot 14,4 kWh", "10 jr garantie", "Stopcontact"], stock: null,
      url: "https://solarnrg.shop/thuisbatterijen/aeg-solarcube-4-8-kwh-plug-in-battery/",
      type: "pnp", module: false, backup: false, kwhMin: 4.8, kwhMax: 14.4, g: { solar: 3, saving: 2, dynamic: 1 } },
    zendure: { featured: false, naam: "Zendure Solarflow 2400AC · plug & play", prijs: "€ 495,–",
      ...
      tags: ["2.400 W", "Plug & Play", "Stopcontact of vaste groep", "Dynamisch"], stock: null,
      url: "https://solarnrg.shop/thuisbatterijen/zendure-solarflow-2400ac/",
      type: "pnp", module: false, backup: false, kwhMin: 2.4, kwhMax: 7.7, g: { solar: 2, saving: 2, dynamic: 3 } },
    sigenergy_1f: { featured: true, naam: "Sigenergy Totaalpakket · 1-fase", prijs: "v.a. € 3.932,–",
      ...
      tags: ["Vast systeem", "Backup inbegrepen", "6–27 kWh", "1-fase", "IP66"], stock: null,
      url: "https://solarnrg.shop/batterijen/totaalpakketten/sigenergy-batterij-totaalpakket-1-fase/",
      type: "vast", module: false, backup: true, kwhMin: 6, kwhMax: 27, g: { solar: 3, saving: 2, dynamic: 3 } },
    sigenergy_3f: { featured: true, naam: "Sigenergy Totaalpakket · 3-fase", prijs: "v.a. € 4.602,–",
      ...
      tags: ["Vast systeem", "Backup inbegrepen", "3-fase", "Hoog vermogen", "IP66"], stock: null,
      url: "https://solarnrg.shop/batterijen/totaalpakketten/sigenergy-batterij-totaalpakket-3-fase/",
      type: "vast", module: false, backup: true, kwhMin: 6, kwhMax: 27, g: { solar: 3, saving: 2, dynamic: 3 } },
    growatt: { featured: false, naam: "Growatt APX Totaalpakket · 5 kWh", prijs: "€ 2.299,–",
      ...
      tags: ["5 kWh", "Compleet pakket", "Voordeligst", "IP66"], stock: null,
      url: "https://solarnrg.shop/batterijen/totaalpakketten/growatt-apx-batterij-totaalpakket/",
      type: "vast", module: false, backup: false, kwhMin: 5, kwhMax: 15, g: { solar: 2, saving: 3, dynamic: 1 } },
    huawei_luna: { featured: false, naam: "Huawei LUNA2000-5KW-C0 · 5 kWh", prijs: "€ 991,–",
      desc: "Losse 5 kWh batterijmodule van Huawei. Combineer met Huawei hybride omvormer. Uitbreidbaar, A-merk kwaliteit.",
      tags: ["5 kWh", "Huawei A-merk", "Uitbreidbaar"], stock: "Op voorraad",
      url: "https://solarnrg.shop/batterijen/huawei-luna2000-5kw-c0/",
      type: "vast", module: true, backup: false, kwhMin: 5, kwhMax: 30, g: { solar: 2, saving: 2, dynamic: 1 } },
    alphaess: { featured: false, naam: "AlphaESS Smile G3-BAT-9.3S · 9,3 kWh", prijs: "€ 2.100,–",
      ...
      tags: ["9,3 kWh", "IP65", "Binnen of buiten"], stock: "Op voorraad",
      url: "https://solarnrg.shop/thuisbatterijen/alphaess-smile-g3-bat-9-3s-ip65/",
      type: "vast", module: true, backup: false, kwhMin: 9.3, kwhMax: 9.3, g: { solar: 3, saving: 1, dynamic: 1 } },
    sessy_5kwh: { featured: false, naam: "Sessy Thuisbatterij · 5 kWh", prijs: "€ 2.820,–",
      ...
      tags: ["5 kWh", "Aparte groep", "Dynamisch contract", "Nederlands merk"], stock: null,
      url: "https://solarnrg.shop/thuisbatterijen/sessy-thuisbatterij-5-kwh-wit/",
      type: "groep", module: false, backup: false, kwhMin: 5, kwhMax: 5, g: { solar: 2, saving: 2, dynamic: 3 } },
    sessy_10kwh: { featured: false, naam: "Sessy Thuisbatterij · 10 kWh", prijs: "€ 4.560,–",
      ...
      tags: ["10 kWh", "Aparte groep", "Dynamisch contract", "Nederlands merk"], stock: null,
      url: "https://solarnrg.shop/thuisbatterijen/sessy-thuisbatterij-10-kwh-wit/",
      type: "groep", module: false, backup: false, kwhMin: 10, kwhMax: 10, g: { solar: 2, saving: 2, dynamic: 3 } }
  };
  ...
  var STEPS = [
    ...
    { id: "installatie", vraag: "Hoe wil je installeren?", sub: "Plug & play = zelf in het stopcontact, geen elektricien. Vast systeem = meer capaciteit en vermogen, installateur nodig.", opties: [
      { icon: "", label: "Plug & play (zelf doen)", sub: "Direct in het stopcontact, geen installateur", waarde: "pnp" },
    ...
    { id: "backup", vraag: "Backup bij stroomuitval — nodig?", sub: "Backup vereist een vast systeem. Sigenergy heeft dit ingebouwd.", opties: [
  ...
  /* ── 4. AANBEVELING: filter (hard) + score (zacht) ──────────────────────── */
  var TARGET = { klein: 4, middel: 7, groot: 12, geen: 7 };

  function capFit(p, cap) {
    var t = TARGET[cap];
    if (t >= p.kwhMin && t <= p.kwhMax) return 3;
    var d = Math.min(Math.abs(t - p.kwhMin), Math.abs(t - p.kwhMax));
    return Math.max(0, 3 - d * 0.4);
  }
  ...
  function getResult(a) {
    ...
    // 1. Backup is de hardste eis: alleen producten met ingebouwde backup (wint van installatievoorkeur)
    var backupEssentieel = (backup === "ja" || gebruik === "backup");
    if (backupEssentieel) {
      ids = ids.filter(function (id) { return PRODUCTS[id].backup; });
    } else {
      // 2. Installatietype-filter (alleen als backup geen eis is)
      if (inst === "pnp")  ids = ids.filter(function (id) { return PRODUCTS[id].type === "pnp"; });
      if (inst === "vast") ids = ids.filter(function (id) { return PRODUCTS[id].type === "vast" || PRODUCTS[id].type === "groep"; });
    }

    // 3. Score op doel + capaciteit (+ kleine nudge voor featured)
    var goalKey = (gebruik === "dynamic") ? "dynamic" : (gebruik === "saving") ? "saving" : "solar";
    var scored = ids.map(function (id) {
      var p = PRODUCTS[id];
      var s = (p.g[goalKey] || 0) + capFit(p, cap) + (p.featured ? 0.6 : 0);
      if (p.module) s -= 0.4;  // lichte voorkeur voor complete systemen boven losse modules
      if (!backupEssentieel) { // fasevoorkeur: groot -> 3-fase, anders 1-fase
        if (id === "sigenergy_3f") s += (cap === "groot" ? 0.2 : -0.2);
        if (id === "sigenergy_1f") s += (cap === "groot" ? -0.2 : 0.2);
      }
      return { id: id, s: s };
    }).sort(function (x, y) { return y.s - x.s; });

    // Buiten de backup-case: toon maar één Sigenergy-fase (1f/3f zijn hetzelfde product)
    if (!backupEssentieel) {
      var seenSig = false;
      scored = scored.filter(function (o) {
        if (o.id === "sigenergy_1f" || o.id === "sigenergy_3f") { if (seenSig) return false; seenSig = true; }
        return true;
      });
    }

    var top = scored.slice(0, 3).map(function (o) { return o.id; });

    // 4. Titel + uitleg
    var titel, uitleg = null;
    if (backupEssentieel) {
      titel = "Batterij met backup-functie";
      uitleg = "Backup bij stroomuitval vereist een vast systeem met installateur. Sigenergy heeft de backup ingebouwd (0 ms omschakeling). Kies 1-fase of 3-fase op basis van je aansluiting.";
    } else if (inst === "pnp") {
      titel = "Plug & play — zonder installateur";
      uitleg = "Deze systemen sluit je zelf aan op een stopcontact. Geen elektricien nodig.";
    } else if (inst === "vast") {
      titel = "Vast systeem — via installateur";
      uitleg = (gebruik === "dynamic") ? "Voor dynamisch handelen telt omvormer vermogen het zwaarst. Sigenergy levert het hoogste vermogen." : null;
    } else {
      titel = (gebruik === "dynamic") ? "Optimaal voor dynamisch contract"
            : (gebruik === "saving")  ? "Slim besparen op energie"
            : "Onze aanbeveling voor jou";
    }
    return { titel: titel, uitleg: uitleg, producten: top };
  }
  ...
  function rr() {
    ...
    var html = r.producten.map(function (id) {
      ...
      return '<div class="kh-product' + (p.featured ? ' featured' : '') + '">' +
        ...
        (p.module ? '<span class="kh-tag warn">⚠ Aparte omvormer nodig</span>' : '') +
  ...
  window.snrgKH = {
    ...
    kies: function (idx) { antwoorden[stap] = STEPS[stap].opties[idx].waarde; stap++; rp(); stap < STEPS.length ? rs() : rr(); },
    terug: function () { if (stap > 0) { stap--; antwoorden.pop(); rp(); rs(); } },
