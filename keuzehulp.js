(function () {
  ...
  var PRODUCTS = {
    ...
    sigenergy_totaal_1f: { featured: true, naam: "Sigenergy Totaalpakket · 1-fase", prijs: "€ 3.932,–", desc: "Compleet systeem incl. controller + backup (0 ms omschakeling). IP66.", tags: ["Backup inbegrepen", "1-fase", "IP66"], stock: null, url: "https://solarnrg.shop/batterijen/totaalpakketten/sigenergy-batterij-totaalpakket-1-fase/" },
    sigenergy_totaal_3f: { featured: true, naam: "Sigenergy Totaalpakket · 3-fase", prijs: "€ 4.602,–", desc: "Compleet 3-fase systeem met backup (0 ms). Geschikt voor grote huishoudens.", tags: ["Backup inbegrepen", "3-fase", "IP66"], stock: null, url: "https://solarnrg.shop/batterijen/totaalpakketten/sigenergy-batterij-totaalpakket-3-fase/" },
