(function () {
  ...
  function getResult(a) {
    ...
    if (gebruik === "dynamic") return { titel: "Optimaal voor dynamisch contract", uitleg: "Voor dynamisch handelen is omvormer vermogen het belangrijkst — hoge laad- en ontlaadsnelheid bepaalt je rendement.", producten: cap === "groot" ? ["sigenergy_totaal_3f", "sigenergy_totaal_1f", "plugplay_klein"] : ["plugplay_klein", "sigenergy_totaal_1f", "sigenergy_totaal_3f"] };
    if (inst === "pnp") {
